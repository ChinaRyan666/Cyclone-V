...
set_false_path -from * -to [get_ports hps_io_hps_io_sdio_inst_PWREN]
...
set_false_path -from [get_ports hps_io_hps_io_sdio_inst_D4] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_sdio_inst_D4]
set_false_path -from [get_ports hps_io_hps_io_sdio_inst_D5] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_sdio_inst_D5]
set_false_path -from [get_ports hps_io_hps_io_sdio_inst_D6] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_sdio_inst_D6]
set_false_path -from [get_ports hps_io_hps_io_sdio_inst_D7] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_sdio_inst_D7]
