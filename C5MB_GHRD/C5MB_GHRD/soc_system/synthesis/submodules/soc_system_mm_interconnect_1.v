...
module soc_system_mm_interconnect_1 (
	...
	wire          rsp_mux_001_src_valid;                                                      // rsp_mux_001:src_valid -> fpga_only_master_master_agent:rp_valid
	wire  [101:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> fpga_only_master_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                      // fpga_only_master_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> fpga_only_master_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                              // rsp_mux_001:src_startofpacket -> fpga_only_master_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                // rsp_mux_001:src_endofpacket -> fpga_only_master_master_agent:rp_endofpacket
	...
	wire  [101:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> sysid_qsys_control_slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                          // sysid_qsys_control_slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire  [101:0] fpga_only_master_master_agent_cp_data;                                      // fpga_only_master_master_agent:cp_data -> router_001:sink_data
	...
	wire  [101:0] sysid_qsys_control_slave_agent_rp_data;                                     // sysid_qsys_control_slave_agent:rp_data -> router_002:sink_data
